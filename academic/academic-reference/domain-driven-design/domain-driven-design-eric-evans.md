...
source: domain-driven-design-eric-evans.pdf
category: Domain-Driven Design / Software Architecture
date: 2026-09-09
---
...
![](assets/domain-driven-design-eric-evans.pdf-0001-00.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0002-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0002-07.png)
...
Expert 1: We call them “component instances.” There could be many of the same component. Expert 2: The “net” box looks just like a component instance. 
...
![](assets/domain-driven-design-eric-evans.pdf-0003-13.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0004-02.png)


Developer: But what exactly do you need to know from this computation? 

Expert 2: We'd be looking for long signal delays—say, any signal path that was more than two or three hops. It's a rule of thumb. If the path is too long, the signal may not arrive during the clock cycle. Developer: More than three hops.... So we need to calculate the path lengths. And what counts as a hop? 
...
![](assets/domain-driven-design-eric-evans.pdf-0004-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0005-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0005-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0009-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0009-13.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0010-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0012-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0012-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0012-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0014-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0014-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0014-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0015-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0016-03.png)


User: So when we change the customs clearance point, we need to redo the whole routing plan. Developer: Right. When you change any of the attributes in the Route Specification , we'll delete the old Itinerary and ask the Routing Service to generate a new one based on the new Route Specification . 
...
“If we give the Routing Service an origin, destination, and arrival time, it can look up the stops the cargo will have to make and, well . . . stick them in the database.” (vague and technical) “The origin, destination, and so on . . . it all feeds into the Routing Service , and we get back an Itinerary that has everything we need in it.” (more complete, but verbose) 
...
![](assets/domain-driven-design-eric-evans.pdf-0019-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0023-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0024-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0026-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0026-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0026-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0026-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0028-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0028-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0028-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0028-11.png)
...
### **From Procedural to M** **_ODEL-_ D** **_RIVEN_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0029-09.png)
...
Desperate engineers worked around this limitation in the layout tool by writing scripts that parse the layout tool's data files and insert rules directly into the file, applying them to an entire bus at a time. The layout tool stores each circuit connection in a net list file, which looks something like this: 
...
![](assets/domain-driven-design-eric-evans.pdf-0031-06.png)
...
**Service Responsibility** Net List import Reads Net List file, creates instance of Net for each entry Net Rule export Given a collection of Nets, writes all attached rules into the Rules File 

We'll also need a few utilities: 

**Class Responsibility** Net Repository Provides access to Nets by name Inferred Bus Factory Given a collection of Nets, uses naming conventions to infer Buses, creates instances Bus Repository Provides access to Buses by name 
...
The second design also accommodates testing. Its components have well-defined interfaces that can be unit-tested. The only way to test the script is to do an end-to-end file-in/file-out comparison. Keep in mind that such a design does not emerge in a single step. It would take several iterations of refactoring and knowledge crunching to distill the important concepts of the domain into a simple, incisive model. 
...
1Brian Marick mentioned this example to me. 
...
![](assets/domain-driven-design-eric-evans.pdf-0035-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0035-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0035-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0036-05.png)
...
|---|---|
|**Application**|Defines the jobs the software is supposed to do and directs the expressive domain objects to work out problems.|
|**Layer**|The tasks this layer is responsible for are meaningful to the business or necessary for interaction with the application<br>layers of other systems.|
...
|**Domain**|Responsible for representing concepts of the business, information about the business situation, and business rules.|
|**Layer (or**<br>**Model Layer)**|State that reflects the business situation is controlled and used here, even though the technical details of storing it<br>are delegated to the infrastructure._This layer is the heart of business software._|
...
![](assets/domain-driven-design-eric-evans.pdf-0038-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0041-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0041-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0041-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0042-15.png)



![](assets/domain-driven-design-eric-evans.pdf-0042-16.png)



![](assets/domain-driven-design-eric-evans.pdf-0042-17.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0046-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0046-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0047-04.png)
...
**Table: CUSTOMER** SS_NUMBER NAME 

**Table: INVESTMENT** ACCOUNT_NUMBER STOCK_SYMBOL AMOUNT 
...
![](assets/domain-driven-design-eric-evans.pdf-0048-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0049-08.png)


Many objects are not fundamentally defined by their attributes, but rather by a thread of continuity and identity. 


![](assets/domain-driven-design-eric-evans.pdf-0049-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0049-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0049-12.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0052-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0052-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0052-06.png)


### **Modeling E** **_NTITIES_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0052-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0054-07.png)


Many objects have no conceptual identity. These objects describe some characteristic of a thing. 


![](assets/domain-driven-design-eric-evans.pdf-0054-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0054-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0054-11.png)
...
### **Is “Address” a V** **_ALUE_ O** **_BJECT_ ? Who's Asking?** 
...
![](assets/domain-driven-design-eric-evans.pdf-0056-04.png)


Figure 5.6. A VALUE OBJECT can give information about an ENTITY. It should be conceptually whole. 


![](assets/domain-driven-design-eric-evans.pdf-0056-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0056-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0056-08.png)


### **Designing V** **_ALUE_ O** **_BJECTS_** 
...
2The WHOLE VALUE pattern, by Ward Cunningham. 
...
### **Tuning a Database with V** **_ALUE_ O** **_BJECTS_** 
...
### **Designing Associations That Involve V** **_ALUE_ O** **_BJECTS_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0059-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0059-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0059-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0059-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0060-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0060-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0060-12.png)


### **S** **_ERVICES_ and the Isolated Domain Layer** 
...
|**Application**|_Funds Transfer App Service_|
|---|---|
||• Digests input (such as an XML request).<br>• Sends message to domain service for fulfillment.<br>• Listens for confirmation.<br>• Decides to send notification using infrastructure service.|
|**Domain**|_Funds Transfer Domain Service_|
||• Interacts with necessary Account and Ledger objects, making appropriate debits and credits.<br>• Supplies confirmation of result (transfer allowed or not, and so on).|
|**Infrastructure**|_Send Notification Service_|
||• Sends e-mails,letters,and other communications as directed bythe application.|
...
![](assets/domain-driven-design-eric-evans.pdf-0062-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0062-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0062-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0063-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0063-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0063-10.png)
...
The four patterns in this chapter provide the building blocks for an object model. But MODELDRIVEN DESIGN does not necessarily mean forcing everything into an object mold. There are also other model paradigms supported by tools, such as rules engines. Projects have to make pragmatic trade-offs between them. These other tools and techniques are means to the end of a MODELDRIVEN DESIGN, not alternatives to it. 
...
### **Sticking with M** **_ODEL_ -D** **_RIVEN_ D** **_ESIGN_ When Mixing Paradigms** 
...
![](assets/domain-driven-design-eric-evans.pdf-0070-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0071-06.png)
...
Schemes have been developed for defining ownership relationships in the model. The following simple but rigorous system, distilled from those concepts, includes a set of rules for implementing transactions that modify the objects and their owners.<sup>1</sup> 
...
1David Siegel devised and used this system on projects in the 1990s but has not published it. 
...
![](assets/domain-driven-design-eric-evans.pdf-0073-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0073-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0074-12.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0075-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0075-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0076-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0076-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0077-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0077-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0078-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0078-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0078-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0078-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0079-03.png)


When creation of an object, or an entire AGGREGATE, becomes complicated or reveals too much of the internal structure, FACTORIES provide encapsulation. 


![](assets/domain-driven-design-eric-evans.pdf-0079-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0079-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0079-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0080-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0080-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0080-13.png)



![](assets/domain-driven-design-eric-evans.pdf-0080-14.png)
...
### **Choosing F** **_ACTORIES_ and Their Sites** 
...
![](assets/domain-driven-design-eric-evans.pdf-0081-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0082-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0082-07.png)
...
### **E** **_NTITY_ F** **_ACTORIES_ Versus V** **_ALUE_ O** **_BJECT_ F** **_ACTORIES_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0085-06.png)


Figure 6.16. Reconstituting an ENTITY retrieved from a relational database 


![](assets/domain-driven-design-eric-evans.pdf-0085-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0086-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0086-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0086-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0086-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0089-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0089-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0089-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0089-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0090-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0090-07.png)
...
### **Client Code Ignores R** **_EPOSITORY_ Implementation; Developers Do Not** 
...
![](assets/domain-driven-design-eric-evans.pdf-0091-06.png)
...
### **The Relationship with F** **_ACTORIES_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0093-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0093-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0097-02.png)
...
## **Distinguishing E** **_NTITIES_ and V** **_ALUE_ Objects** 
...
![](assets/domain-driven-design-eric-evans.pdf-0100-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0102-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0103-02.png)
...
### **F** **_ACTORIES_ and Constructors for Cargo** 
...
![](assets/domain-driven-design-eric-evans.pdf-0106-02.png)
...
## **Pause for Refactoring: An Alternative Design of the Cargo A** **_GGREGATE_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0107-03.png)
...
## **M** **_ODULES_ in the Shipping Model** 
...
![](assets/domain-driven-design-eric-evans.pdf-0109-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0110-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0111-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0112-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0113-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0115-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0116-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0117-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0117-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0118-03.png)


Figure 8.4. Lender B opts out of a second drawdown. 


![](assets/domain-driven-design-eric-evans.pdf-0118-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0118-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0119-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0119-09.png)
...
|Q1:|How long would it take to get back to current functionality with the<br>new design?|
|---|---|
|A1:|About three weeks.|
|Q2:|Could we solve the problems without it?|
|A2:|Probably. But no way to be sure.|
|Q3:|Would we be able to move forward in the next release if we didn't<br>do it now?|
|A3:|Forward movement would be slow without the change. And the<br>change would be much harder once we had an installed base.|
|Q4:|Did we think it was the right thing to do?|
|A4:|We knew the political situation was unstable, so we'd cope if we had<br>to. And we were tired. But, yes, it was a simpler solution that fit the<br>business much better. In the long run it was lower risk.|
...
![](assets/domain-driven-design-eric-evans.pdf-0122-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0124-10.png)
...
Developer: The cargo ID, the vessel voyage, the loading port, and the unloading port for each leg. Expert: What about the date? Operations will need to contract handling work based on the expected times. 
...
![](assets/domain-driven-design-eric-evans.pdf-0125-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0126-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0127-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0128-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0129-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0129-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0130-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0131-13.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0133-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0134-12.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0135-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0136-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0137-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0137-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0137-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0137-07.png)
...
### **Applying and Implementing S** **_PECIFICATION_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0138-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0140-02.png)
...
Without using SPECIFICATION, a generator can be written that has procedures or a set of instructions that create the needed objects. This code implicitly defines the behavior of the generator. Instead, an interface of the generator that is defined in terms of a descriptive SPECIFICATION explicitly constrains the generator's products. This approach has several advantages. 
...
![](assets/domain-driven-design-eric-evans.pdf-0143-07.png)
...
|---|---|---|
|Armored|20 lbs. TNT<br>500 lbs. sand|✓|
...
![](assets/domain-driven-design-eric-evans.pdf-0147-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0149-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0150-10.png)
...
- `// Create a pure yellow paint with volume=100 Paint yellow = new Paint(100.0, 0, 50, 0);` 

- `// Create a pure blue paint with volume=100 Paint blue = new Paint(100.0, 0, 0, 50);` 
...
![](assets/domain-driven-design-eric-evans.pdf-0151-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0151-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0151-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0151-10.png)


Entire subdomains can be carved off into separate modules and encapsulated behind INTENTIONREVEALING INTERFACES. Using such whittling to focus a project and manage the complexity of a large system will be discussed more in Chapter 15, “Distillation,” with COHESIVE MECHANISMS and GENERIC SUBDOMAINS. 
...
![](assets/domain-driven-design-eric-evans.pdf-0153-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0154-02.png)


Figure 10.5. The side effects of the _`mixIn()`_ method 
...
![](assets/domain-driven-design-eric-evans.pdf-0154-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0155-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0155-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0155-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0155-13.png)



![](assets/domain-driven-design-eric-evans.pdf-0155-14.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0156-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0156-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0156-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0157-06.png)


The receiver's volume is increased by the amount of the argument's volume. Drawing on our general understanding of physical paint, this mixing process should deplete the other paint by the same amount, draining it to zero volume, or eliminating it completely. The current implementation does not modify the argument, and modifying arguments is a particularly risky kind of side effect anyway. To start on a solid footing, let's state the post-condition of the `mixIn()` method as it is: 
...
We seem to be giving Paint two different basic responsibilities. Let's try splitting them. Now there is only one command, `mixIn()` . It just adds an object to a collection, an effect apparent from an intuitive understanding of the model. All other operations are SIDE-EFFECT-FREE FUNCTIONS. 
...
![](assets/domain-driven-design-eric-evans.pdf-0158-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0159-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0159-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0159-05.png)
...
1The WHOLE VALUE pattern, by Ward Cunningham. 
...
![](assets/domain-driven-design-eric-evans.pdf-0161-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0162-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0162-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0163-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0163-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0163-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0164-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0164-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0164-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0166-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0166-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0166-05.png)
...
### **Extending S** **_PECIFICATIONS_ in a Declarative Style** 
...
#### **Combining S** **_PECIFICATIONS_ Using Logical Operators** 
...
![](assets/domain-driven-design-eric-evans.pdf-0170-06.png)
...
### **One Alternative Implementation of C** **_OMPOSITE_ S** **_PECIFICATION_** 
...
**SPECIFICATION Stack Content for “Cheap Container”** Top AndSpecificationOperator (F _LY_ W _EIGHT_ ) NotSpecificationOperator (F _LY_ W _EIGHT_ ) Armored NotSpecificationOperator Ventilated 
...
![](assets/domain-driven-design-eric-evans.pdf-0172-08.png)
...
**Socrates on SPECIFICATIONS** All men are mortal. `Specification manSpec = new ManSpecification(); Specification mortalSpec = new MortalSpecification(); assert manSpec.subsumes(mortalSpec);` Socrates is a man. `Man socrates = new Man(); assert manSpec.isSatisfiedBy(socrates);` Therefore, Socrates is mortal. `assert mortalSpec.isSatisfiedBy(socrates);` 
...
![](assets/domain-driven-design-eric-evans.pdf-0175-04.png)
...
#### **Separating Commands and S** **_IDE_ -E** **_FFECT_ -F** **_REE_ F** **_UNCTIONS_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0175-12.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0177-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0177-04.png)
...
**Share Pie Becomes a V** **_ALUE_ O** **_BJECT_ : Cascade of Insights** 
...
![](assets/domain-driven-design-eric-evans.pdf-0178-07.png)
...
`public SharePie minus(SharePie otherShares) { SharePie result = new SharePie(); Set owners = new HashSet(); owners.addAll(getOwners()); owners.addAll(otherShares.getOwners());` _`The difference between two Pies is the difference`_ ↩ _`between each owner's share.`_ `Iterator it = owners.iterator(); while(it.hasNext()) {` 

Supple Design 

186 

`Object owner = it.next(); double resultShareAmount = getShareAmount(owner) – otherShares.getShareAmount(owner); result.add(owner, resultShareAmount); } return result; } public SharePie plus(SharePie otherShares) {` _`The combination of two Pies is the combination of`_ ↩ _`each owner's share.`_ `//Similar to implementation of minus() } public SharePie prorated(double amountToProrate) { SharePie proration = new SharePie(); double basis = getAmount();` _`An amount can be divided proportionately among all shareholders.`_ `Iterator it = shares.keySet().iterator(); while(it.hasNext()) { Object owner = it.next(); Share share = getShare(owner); double proratedShareAmount = share.getAmount() / basis * amountToProrate; proration.add(owner, proratedShareAmount); } return proration; } }` 
...
![](assets/domain-driven-design-eric-evans.pdf-0182-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0183-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0183-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0184-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0185-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0185-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0186-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0187-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0188-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0189-05.png)


Figure 11.10. The class diagram with Posting Rules 


![](assets/domain-driven-design-eric-evans.pdf-0189-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0192-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0193-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0193-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0194-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0194-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0194-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0194-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0195-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0196-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0196-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0196-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0196-10.png)


<!-- Start of picture text -->
Figure 12.6. The business experts' conception of a route<br><!-- End of picture text -->
...
![](assets/domain-driven-design-eric-evans.pdf-0197-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0198-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0199-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0199-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0199-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0199-08.png)


## **Why Not F** **_LYWEIGHT?_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0207-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0207-05.png)
...
### **B** **_OUNDED_ C** **_ONTEXTS_ Are Not M** **_ODULES_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0209-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0209-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0209-13.png)
...
### **Recognizing Splinters Within a B** **_OUNDED_ C** **_ONTEXT_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0211-03.png)


Having defined a BOUNDED CONTEXT, we must keep it sound. 


![](assets/domain-driven-design-eric-evans.pdf-0211-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0211-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0211-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0212-13.png)



![](assets/domain-driven-design-eric-evans.pdf-0212-14.png)



![](assets/domain-driven-design-eric-evans.pdf-0212-15.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0213-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0213-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0213-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0213-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0214-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0214-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0214-05.png)
...
### **Two C** **_ONTEXTS_ in a Shipping Application** 
...
![](assets/domain-driven-design-eric-evans.pdf-0214-12.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0215-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0216-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0216-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0217-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0217-08.png)
...
### **Testing at the C** **_ONTEXT_ Boundaries** 
...
### **Organizing and Documenting C** **_ONTEXT_ M** **_APS_** 
...
1Reagan translated an old Russian saying that summed up the heart of the matter for both sides—another metaphor for bridging contexts. 
...
## **Relationships Between B** **_OUNDED_ C** **_ONTEXTS_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0219-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0220-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0220-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0220-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0220-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0220-13.png)



![](assets/domain-driven-design-eric-evans.pdf-0220-14.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0221-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0221-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0221-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0221-07.png)
...
If a process other than XP is used, whatever analogous method serves to balance the concerns of different users can be expanded to include the downstream application's needs. Therefore: 
...
![](assets/domain-driven-design-eric-evans.pdf-0223-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0223-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0223-13.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0224-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0225-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0225-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0225-13.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0226-03.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0226-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0226-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0226-07.png)
...
make the interface to the other system operate at such a low level. A low-level interface takes away the power of the other system's model to explain the data and constrain its values and relationships, while saddling the new system with the burden of interpreting primitive data that is not in terms of its own model. 
...
![](assets/domain-driven-design-eric-evans.pdf-0227-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0227-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0227-08.png)
...
### **Designing the Interface of the A** **_NTICORRUPTION_ L** **_AYER_** 
...
### **Implementing the A** **_NTICORRUPTION_ L** **_AYER_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0228-08.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0230-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0230-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0230-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0230-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0231-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0231-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0231-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0231-16.png)



![](assets/domain-driven-design-eric-evans.pdf-0231-17.png)



![](assets/domain-driven-design-eric-evans.pdf-0231-18.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0232-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0232-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0232-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0232-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0232-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0232-13.png)
...
Recently, the world of e-commerce has become very excited about a new technology: Extensible Markup Language (XML) promises to make interchange of data much easier. A very valuable feature of XML is that, through the document type definition (DTD) or through XML schemas, XML allows the formal definition of a specialized domain language into which data can be translated. Industry 

242 

Maintaining Model Integrity 

groups have begun to form for the purpose of defining a single standard DTD for their industry so that, say, chemical formula information or genetic coding can be communicated between many parties. Essentially these groups are creating a shared domain model in the form of a language definition. 
...
### **A P** **_UBLISHED_ L** **_ANGUAGE_ for Chemistry** 
...
`<CML.ARR ID="array3" EL.TYPE=FLOAT NAME="ATOMIC ORBITAL ELECTRON POPULATIONS" SIZE=30` ↩ `GLO.ENT=CML.THE.AOEPOPS> 1.17947   0.95091   0.97175   1.00000   1.17947   0.95090   0.97174   1.00000 1.17946   0.98215   0.94049   1.00000   1.17946   0.95091   0.97174   1.00000 1.17946   0.95091   0.97174   1.00000   1.17946   0.98215   0.94049   1.00000 0.89789   0.89790   0.89789   0.89789   0.89790   0.89788 </CML.ARR>` 


![](assets/domain-driven-design-eric-evans.pdf-0234-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0234-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0234-08.png)
...
—From “The Blind Men and the Elephant,” by John Godfrey Saxe (1816–1887), based on a story in the Udana, 
...
![](assets/domain-driven-design-eric-evans.pdf-0235-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0236-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0236-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0237-03.png)
...
#### **Favoring Larger B** **_OUNDED_ C** **_ONTEXTS_** 
...
#### **Favoring Smaller B** **_OUNDED_ C** **_ONTEXTS_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0241-09.png)
...
### **Merging C** **_ONTEXTS_ : S** **_EPARATE_ W** **_AYS_ S** **_HARED_ K** **_ERNEL_** 
...
### **Merging C** **_ONTEXTS_ : S** **_HARED_ K** **_ERNEL_ C** **_ONTINUOUS_ I** **_NTEGRATION_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0247-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0248-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0248-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0250-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0250-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0250-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0252-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0252-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0252-12.png)
...
|---|---|
|_Advantages_|_Advantage_|
|• G_ENERIC_model decoupled from C_ORE_.|• G_ENERIC_model decoupled from_CORE_.|
|• C_ORE_model mature, so resources could be diverted with-<br>out stunting it.|_Disadvantages_|
|• Knew exactly what they needed.<br>• Critical support functionality for international scheduling.<br>• Programmer on short-term contract used for_GENERIC_<br>task.|• C_ORE_model undeveloped, so attention to other issues con-<br>tinued this neglect.<br>• Unknown requirements led to attempt at full generality, where<br>simpler North America-specific conversion might have suf-<br>ficed.|
|_Disadvantage_|• Long-term programmers were assigned who could have been<br>repositories of domain knowledge.|
...
**Shipping Project's Strategy** • Diverted top <u>programmer from core.</u> 
...
|**This is part of a DOMAIN VISION STATEMENT**|**This, though important, is****_not_ part of a DOMAIN VISION**<br>**STATEMENT**|
|---|---|
|_Airline Booking System_|_Airline Booking System_|
|The model can represent passenger priorities and airline book-<br>ing strategies and balance these based on flexible policies. The|The UI should be streamlined for expert users but accessible to<br>first-time users.|
|model of a passenger should reflect the “relationship” the air-<br>line is striving to develop with repeat customers. Therefore, it<br>should represent the history of the passenger in useful con-<br>densed form, participation in special programs, affiliation with<br>strategic corporate clients, and so on.|Access will be offered over the Web, by data transfer to other sys-<br>tems, and maybe through other UIs, so interface will be designed<br>around XML with transformation layers to serve Web pages or<br>translate to other systems.|
|Different roles of different users (such as passenger, agent,<br>manager) are represented to enrich the model of relationships|A colorful animated version of the logo needs to be cached on the<br>client machine so that it can come up quickly on future visits.|
|and to feed necessary information to the security framework.|When customer submits a reservation, make visual confirmation<br>|
|Model should support efficient route/seat search and integra-|within 5 seconds.|
|tion with other established flight booking systems.|A security framework will authenticate a user's identity and then<br>limit access to specific features based on privileges assigned to<br>defined user roles.|
|**This is part of a DOMAIN VISION STATEMENT**|**This, though important, is****_not_ part of a DOMAIN VI-**<br>**SION STATEMENT**|
|_Semiconductor Factory Automation_|_Semiconductor Factory Automation_|
...
**This is part of a DOMAIN VISION STATEMENT This, though important, is** **_not_ part of a DOMAIN VISION STATEMENT** The domain model will represent the status of materials and equipThe software should be Web enabled through a servlet, but ment within a wafer fab in such a way that necessary audit trails can structured to allow alternative interfaces. be provided and automated product routing can be supported. Industry-standard technologies should be used whenever The model will not include the human resources required in the procpossible to avoid in-house development and maintenance ess, but must allow selective process automation through recipe costs and to maximize access to outside expertise. Open download. source solutions are preferred (such as Apache Web server). The representation of the state of the factory should be comprehenThe Web server will run on a dedicated server. The applicasible to human managers, to give them deeper insight and support tion will run on a single dedicated server. better decision making. 


![](assets/domain-driven-design-eric-evans.pdf-0258-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0258-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0258-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0258-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0258-10.png)



![](assets/domain-driven-design-eric-evans.pdf-0258-11.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0260-14.png)



![](assets/domain-driven-design-eric-evans.pdf-0260-15.png)



![](assets/domain-driven-design-eric-evans.pdf-0260-16.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0262-07.png)



![](assets/domain-driven-design-eric-evans.pdf-0262-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0262-09.png)


### **G** **_ENERIC_ S** **_UBDOMAIN_ Versus C** **_OHESIVE_ M** **_ECHANISM_** 
...
### **When a M** **_ECHANISM_ Is Part of the C** **_ORE_ D** **_OMAIN_** 
...
### **Full Circle: Organization Chart Reabsorbs Its M** **_ECHANISM_** 
...
COHESIVE MECHANISMS are by far most useful when they provide access through an INTENTION-REVEALING INTERFACE, with conceptually coherent ASSERTIONS and SIDE-EFFECTFREE FUNCTIONS. MECHANISMS and supple designs allow the CORE DOMAIN to make meaningful statements rather than calling obscure functions. But an exceptional payoff comes when part of the CORE DOMAIN itself breaks through to a deep model and starts to function as a language that can express the most important application scenarios flexibly and concisely. 
...
![](assets/domain-driven-design-eric-evans.pdf-0264-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0264-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0264-10.png)
...
### **The Costs of Creating a S** **_EGREGATED_ C** **_ORE_** 
...
### **Segregating the C** **_ORE_ of a Cargo Shipping Model** 

We start with the model shown in Figure 15.2 as the basis of software for cargo shipping coordination. 


![](assets/domain-driven-design-eric-evans.pdf-0265-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0267-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0269-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0270-03.png)


Even the CORE DOMAIN model usually has so much detail that communicating the big picture can be difficult. 


![](assets/domain-driven-design-eric-evans.pdf-0270-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0270-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0270-07.png)
...
We are not looking for a technical trick here. This is a valuable technique only when the polymorphic interfaces correspond to fundamental concepts in the domain. In that case, separating these abstractions decouples the MODULES while distilling a smaller and more cohesive CORE DOMAIN. Therefore: 
...
![](assets/domain-driven-design-eric-evans.pdf-0271-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0271-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0271-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0272-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0274-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0276-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0276-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0276-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0276-11.png)



![](assets/domain-driven-design-eric-evans.pdf-0276-12.png)



![](assets/domain-driven-design-eric-evans.pdf-0276-13.png)
...
1SYSTEM METAPHOR finally made sense to me when I heard Ward Cunningham use this firewall example in a workshop lecture. 
...
That said, SYSTEM METAPHOR is a well-known form of large-scale structure that is useful on some projects, and it nicely illustrates the general concept of a structure. Therefore: 
...
![](assets/domain-driven-design-eric-evans.pdf-0277-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0277-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0277-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0277-18.png)



![](assets/domain-driven-design-eric-evans.pdf-0277-19.png)



![](assets/domain-driven-design-eric-evans.pdf-0277-20.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0278-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0279-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0279-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0279-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0279-14.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0280-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0281-02.png)


Figure 16.5. A query replaces a bidirectional association that violates the layering. 


![](assets/domain-driven-design-eric-evans.pdf-0281-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0282-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0282-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0283-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0283-06.png)


<!-- Start of picture text -->
Figure 16.9. A possible design for routing hazardous cargo<br><!-- End of picture text -->


![](assets/domain-driven-design-eric-evans.pdf-0283-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0284-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0285-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0287-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0287-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0288-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0289-05.png)


Figure 16.15. The old model, overconstrained for new requirements 


![](assets/domain-driven-design-eric-evans.pdf-0289-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0290-02.png)


Figure 16.17. The proposed model, now underconstrained 


![](assets/domain-driven-design-eric-evans.pdf-0290-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0290-09.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0291-02.png)
...
|**Fowler Terminology**|**POSA Terminology**<sup>2</sup>|
|---|---|
...
2POSA is short for Pattern-Oriented Software Architecture, by Buschmann et al. 1996. 
...
### **Employee Payroll and Pension, Part 2: K** **_NOWLEDGE_ L** **_EVEL_** 
...
![](assets/domain-driven-design-eric-evans.pdf-0293-05.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0294-02.png)


Figure 16.22. Payroll is now explicit, distinct from Employee Type . 


![](assets/domain-driven-design-eric-evans.pdf-0294-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0294-08.png)



![](assets/domain-driven-design-eric-evans.pdf-0294-09.png)



![](assets/domain-driven-design-eric-evans.pdf-0294-10.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0294-15.png)



![](assets/domain-driven-design-eric-evans.pdf-0294-16.png)



![](assets/domain-driven-design-eric-evans.pdf-0294-17.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0296-07.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0297-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0297-05.png)



![](assets/domain-driven-design-eric-evans.pdf-0297-06.png)



![](assets/domain-driven-design-eric-evans.pdf-0297-07.png)
...
## **Combining Large-Scale Structures and B** **_OUNDED_ C** **_ONTEXTS_** 


![](assets/domain-driven-design-eric-evans.pdf-0301-04.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0302-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0302-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0303-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0303-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0304-05.png)
...
1. Draw a CONTEXT MAP. Can you draw a consistent one, or are there ambiguous situations? 2. Attend to the use of language on the project. Is there a UBIQUITOUS LANGUAGE? Is it rich enough to help development? 
...
When a large-scale structure spans multiple teams, closely affiliated teams may begin to collaborate informally. In such a situation, each application team still makes the discoveries that lead to the idea for a large-scale structure, but then particular options are discussed by the informal committee, made up of representatives of the various teams. After assessing the impact of the design, partici- 

Bringing the Strategy Together 

315 

pants may decide to adopt it, modify it, or leave it on the table. The teams attempt to move together in this loose affiliation. This arrangement can work when there are relatively few teams, when they are all committed to coordinating with each other, when their design capabilities are comparable, and when their structural needs are similar enough to be met by a single large-scale structure. 
...
![](assets/domain-driven-design-eric-evans.pdf-0311-02.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0311-06.png)
...
![](assets/domain-driven-design-eric-evans.pdf-0316-14.png)



![](assets/domain-driven-design-eric-evans.pdf-0316-15.png)



![](assets/domain-driven-design-eric-evans.pdf-0316-16.png)


] 

[Problem discussion.] Problem summary. Discussion of the resolution of problem forces into a solution. Therefore: Solution summary. 
...
![](assets/domain-driven-design-eric-evans.pdf-0317-03.png)



![](assets/domain-driven-design-eric-evans.pdf-0317-04.png)



![](assets/domain-driven-design-eric-evans.pdf-0317-05.png)
...
An operation offered as an interface that stands alone in the model, with no encapsulated state. side effect 
...
- [biblio01entry01] C., Alexander, M. Silverstein, S. Angel, S. Ishikawa, and D. Abrams. 1975. The Oregon Experiment. Oxford University Press. 

- [biblio01entry02] C., Alexander, S. Ishikawa, and M. Silverstein. 1977. A Pattern Language: Towns, Buildings, Construction. Oxford University Press. 

- [biblio01entry03] D., Alur, J. Crupi, and D. Malks. 2001. Core J2EE Patterns. Sun Microsystems Press. 

- [biblio01entry04] K. Beck, 1997. Smalltalk Best Practice Patterns. Prentice Hall PTR. 

- [biblio01entry05] ———. 2000. Extreme Programming Explained: Embrace Change. Addison-Wesley. 

- [biblio01entry06] ———. 2003. Test-Driven Development: By Example. Addison-Wesley. 

- [biblio01entry07] F., Buschmann, R. Meunier, H. Rohnert, P. Sommerlad, and M. Stal. 1996. Pattern-Oriented Software Architecture: A System of Patterns. Wiley. 

- [biblio01entry08] A. Cockburn, 1998. Surviving Object-Oriented Projects: A Manager's Guide. Addison-Wesley. 

- [biblio01entry09] E., Evans, and M. Fowler. 1997. “Specifications.” Proceedings of PLoP 97 Conference. 

- [biblio01entry10] M., Fayad, and R. Johnson. 2000. Domain-Specific Application Frameworks. Wiley. 

- [biblio01entry11] M. Fowler, 1997. Analysis Patterns: Reusable Object Models. Addison-Wesley. 

- [biblio01entry12] ———. 1999. Refactoring: Improving the Design of Existing Code. Addison-Wesley. 

- [biblio01entry13] ———. 2003. Patterns of Enterprise Application Architecture. Addison-Wesley. 

- [biblio01entry14] E., Gamma, R. Helm, R. Johnson, and J. Vlissides. 1995. Design Patterns. Addison-Wesley. 

- [biblio01entry15] J. Kerievsky, 2003. “Continuous Learning,” in Extreme Programming Perspectives, Michele Marchesi et al. Addison-Wesley. 

- [biblio01entry16] ———. 2003. Web site: http://www.industriallogic.com/xp/refactoring. 

- [biblio01entry17] C. Larman, 1998. Applying UML and Patterns: An Introduction to Object-Oriented Analysis and Design. Prentice Hall PTR. 

- [biblio01entry18] Merriam-Webster. 1993. Merriam-Webster's Collegiate Dictionary. Tenth edition. Merriam-Webster. 

- [biblio01entry19] B. Meyer, 1988. Object-oriented Software Construction. Prentice Hall PTR. 

- [biblio01entry20] P., Murray-Rust, H. Rzepa, and C. Leach. 1995. Abstract 40. Presented as a poster at the 210th ACS Meeting in Chicago on August 21, 1995. http://www.ch.ic.ac.uk/cml/ 

References 

332 

- [biblio01entry21] S. Pinker, 1994. The Language Instinct: How the Mind Creates Language. HarperCollins. 

- [biblio01entry22] G. J., Succi, D. Wells, M. Marchesi, and L. Williams. 2002. Extreme Programming Perspectives. Pearson Education. 

- [biblio01entry23] J., Warmer, and A. Kleppe. 1999. The Object Constraint Language: Precise Modeling with UML. Addison-Wesley. 

- [biblio01entry24] R., Wirfs-Brock, B. Wilkerson, and L. Wiener. 1990. Designing Object-Oriented Software. Prentice Hall PTR. 

- [biblio01entry25] R., Wirfs-Brock, and A. McKean. 2003. Object Design: Roles, Responsibilities, and Collaborations. Addison-Wesley. 
...
Richard A. Paselk, Humboldt State University Astrolabe (Chapter 3, page 47) 

© Royalty-Free/Corbis Fingerprint (Chapter 5, page 89), Service Station (Chapter 5, page 104), Auto Factory (Chapter 6, page 136), Librarian (Chapter 6, page 147) 

Martine Jousset Grapes (Chapter 6, page 125), Olive Trees (young and old)(Conclusion, pages 500–501) Biophoto Associates/Photo Researchers, Inc. Electron micrograph of Oscillatoria (Chapter 14, page 335) 

Ross J. Venables 

Rowers (group and single) (Chapter 14, pages 341 and 371) 

Photodisc Green/Getty Images Runners (Chapter 14, page 356), Child (Chapter 14, page 361) 

U.S. National Oceanic and Atmospheric Administration Great Wall of China (Chapter 14, page 364) © 2003 NAMES Project Foundation, Atlanta, Georgia. Photographer Paul Margolies. www.aidsquilt.org AIDS Quilt (Chapter 16, page 439) 
